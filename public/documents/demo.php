...
<head>
    ...
    <style rel="stylesheet">
        ...
        .fonthd:after{ content: "\f040";}
        .fontFam:after{ content:"\f034";}
        .fontSi:after{ content:"\f035";}
        .fontCol:after{content:"\f031";}
        .fontBck:after{ content:"\f043";}


        .fonthd:hover:after,.fontFam:hover:after,
        .fontSi:hover:after,.fontCol:hover:after,
        .fontBck:hover:after,.send-btn:hover,
        .intLink:hover{
        color:#1AC0F5;
        cursor: pointer;
        ...
        #thisForm {box-shadow: 0 5px 25px 10px #35AC8B;}
        #textBox{ height:500px;}
        #editor_area {width: 98.5%;min-height: 200px;margin:2px}
        .main{
            width:800px;
            margin:0 auto;
        }
...
<body>
    <div class="boxes">
        <div class="box-1">
        <p class="boxes center">Es un editor de texto básico, no esperes mucho ya que son unas pocas lineas de código comparado con otros editores.</p>

            <!--- call editor -->
            <div id="editor_panel"></div>
            <textarea id="editor_area"><h1><font color="#34495e"><b>Welcome to My Page</b></font></h1><p>This is a sample page with some HTML content and styles.</p><p>Now, let's include a code snippet in Python:</p><pre><font face="Andale Mono, AndaleMono, monospace" size="2"><font color="#333333" style="">def greet(name):<br></font><font color="#333333" style="">   print("Hello, " + name)<br></font><font color="#333333" style="">greet("World")</font></font></pre><p>And here's a code snippet in JavaScript:</p><pre><font face="Consolas, monaco, monospace" size="2"><font color="#333333" style="">function greet(name) {<br></font><span style="color: rgb(51, 51, 51); font-weight: var(--font-weight);">&nbsp; console.log("Hello, " + name);<br></span><font color="#333333" style="">}<br></font><span style="color: rgb(51, 51, 51); font-weight: var(--font-weight);">greet("World");</span></font></pre></textarea>
            <p class="boxes center"><a href="https://codepen.io/nakome/pen/vYxYKY" target="_blank" rel="noopener" title="Proyecto en Codepen.io" >Proyecto en Codepen</a></p>
        </div>
    </div>
    
    
    <div id="test"><h1><b style=""><font color="#3498db">Welcome to My Page</font></b></h1><p><b>This is a sample page with some HTML content and styles.</b></p><p><b>Now, let's include a code snippet in Python:</b></p><pre><font face="Andale Mono, AndaleMono, monospace" size="2"><font color="#333333" style="">def greet(name):<br></font><font color="#333333" style="">   print("Hello, " + name)<br></font><font color="#333333" style="">greet("World")</font></font></pre><p><b>And here's a code snippet in JavaScript:</b></p><pre><font face="Consolas, monaco, monospace" size="2"><font color="#333333" style="">function greet(name) {<br></font><span style="color: rgb(51, 51, 51); font-weight: var(--font-weight);">&nbsp; console.log("Hello, " + name);<br></span><font color="#333333" style="">}<br></font><span style="color: rgb(51, 51, 51); font-weight: var(--font-weight);">greet("World");</span></font></pre></div>
